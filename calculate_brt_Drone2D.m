...
N = [6; 6];         % Number of grid points per dimension
g = createGrid(grid_min, grid_max,N);
%% target set
R = 1;
% data0 = shapeCylinder(grid,ignoreDims,center,radius)
data0 = shapeCylinder(g, 3, [0; 0], R);
%% time vector
t0 = 0;
tMax = 1;
dt = 0.1;
...
%obj = Drone2D(x, angleRange, speed, dRange, dims)
sys = Drone2D( x0, angleRange, speed, dRange); %do dStep3 here
